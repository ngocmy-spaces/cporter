...
- 📦 [Artifact & packaging](docs/ARTIFACT.md) — how to build the deploy `.zip` (contract + a recipe per project type)
- 🔑 [Environment variables](docs/ENVIRONMENT.md) — managing `.env` (cPorter-managed vs bundled)
