...
| **T0.2** | Web SPA shell | ✅ | React 19 + Vite + TS + Tailwind v4 + Router + React Query; layout + 8 trang stub; **build + lint pass** | §13 |
...
| **T0.5** | Domain model + migrations | 🔜 | Migrations + Eloquent models: `projects`, `releases`, `artifacts`, `deployments`, `api_keys`, `audit_logs` (schema ở §5) | §5 |
